...
public class readGuaradian extends Activity {
	private WebView browser;
	   String url = "http://www.theguardian.com/uk";
	   ImageButton bttn ;
 ...
 protected void onCreate(Bundle savedInstanceState) {
     ...
     setContentView(R.layout.news_guardian);
     
     browser = (WebView)findViewById(R.id.webguardian);
     ...
     browser.loadUrl(url);
    new Sound().onStart();
     /*bttn = (ImageButton) findViewById(R.id.playHt);
 ...
 private class Click extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			mProgressDialog = new ProgressDialog(readGuaradian.this);
		...
		protected Void doInBackground(Void... params) {
				...
				try {
					...
					Elements description = document
							.select("div[class=content__article-body from-content-api js-article__body]");
