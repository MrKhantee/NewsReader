...
public class readSyndneyMorning extends Activity {
	...
	final Context myApp = this; 
	   String url = "http://www.smh.com.au/index.html";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        browser.getSettings().setLoadsImagesAutomatically(true); //.getSettings().setJavaScriptEnabled(true);
    ...
    private class Click extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			mProgressDialog = new ProgressDialog(readSyndneyMorning.this);
