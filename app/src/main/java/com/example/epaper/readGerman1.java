...
public class readGerman1 extends Activity {
	...
	final Context myApp = this; 
	   String url = "http://www.washingtontimes.com/";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.news_eco);
      
        browser = (WebView)findViewById(R.id.webeco);
    ...
    private class Click extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			mProgressDialog = new ProgressDialog(readGerman1.this);
